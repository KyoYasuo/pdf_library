    ...
    for (const annotation of annotations) {
      ...
      switch (annotation.annotationType) {
        ...
        case AnnotationEditorType.CIRCLE:
          promises.push(
            CircleAnnotation.createNewAnnotation(xref, annotation, dependencies)
          );
          break;
    ...
    if (!this.appearance) {
      ...
      this._setDefaultAppearance({
        ...
        pointsCallback: (buffer, points) => {
          ...
          console.log("SquareAnnotation: ", xref, this.borderStyle.width, strokeColor, fillColor, strokeAlpha, fillAlpha, [points[0].x, points[1].x, points[3].y, points[1].y]);
    ...
    if (!this.appearance) {
      ...
      this._setDefaultAppearance({
        ...
        pointsCallback: (buffer, points) => {
          ...
          console.log("InkAnnotation: ", xref, borderWidth, strokeColor, strokeAlpha, [points[0].x, points[1].x, points[3].y, points[1].y]);
          return [points[0].x, points[1].x, points[3].y, points[1].y];
        },
      });
    }
