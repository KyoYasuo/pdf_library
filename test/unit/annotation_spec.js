...
describe("annotation", function () {
  ...
  //   it("should handle a single square list", async function () {
  //     const squareDict = new Dict();
  //     squareDict.set("Type", Name.get("Annot"));
  //     squareDict.set("Subtype", Name.get("Square"));
  //     squareDict.set("squareList", [[1, 1, 1, 2, 2, 2, 3, 3]]);

  //     const squareRef = Ref.get(142, 0);
  ...
  //     expect(data.squareLists.length).toEqual(1);
  //     expect(data.squareLists[0]).toEqual([
  //       { x: 1, y: 1 },
  //       { x: 1, y: 2 },
  //       { x: 2, y: 2 },
  //       { x: 3, y: 3 },
